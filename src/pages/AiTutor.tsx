...
const AiTutor = () => (
  <div className="min-h-screen bg-background flex items-center justify-center px-4">
    <div className="text-center max-w-sm">
      ...
      <h1 className="text-2xl font-bold text-foreground">Tutor com IA</h1>
      <p className="text-muted-foreground mt-2">
        Em breve você poderá conversar com um tutor inteligente para tirar dúvidas e aprofundar seus estudos.
      </p>
      <Link
        to="/dashboard"
