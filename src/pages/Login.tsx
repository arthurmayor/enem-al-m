        ...
        <div className="bg-card rounded-xl shadow-rest p-8">
          ...
          {!resetMode && (
            <>
              ...
              <button
                type="button"
                className="w-full h-11 rounded-lg bg-background border border-border text-foreground text-sm font-medium hover:bg-secondary transition-all flex items-center justify-center gap-2"
              >
