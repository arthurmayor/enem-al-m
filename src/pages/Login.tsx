    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card rounded-xl shadow-rest p-8">
          <h1 className="text-xl font-bold text-foreground text-center">Entrar na sua conta</h1>
          <p className="text-sm text-muted-foreground text-center mt-1">Continue seus estudos</p>
